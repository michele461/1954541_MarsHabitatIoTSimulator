...
export const SIMULATOR_URL: string = process.env.SIMULATOR_URL || 'http://localhost:8080';
export const RABBITMQ_URL: string = process.env.RABBITMQ_URL || 'amqp://localhost';
export const WS_BASE_URL: string = process.env.WS_BASE_URL || 'ws://localhost:8080';
...
export const MONGO_CONFIG: MongoDriverConfig = {
    uri: process.env.MONGO_URL || 'http://localhost:8080',
